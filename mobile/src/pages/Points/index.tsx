...
import {View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, Alert, addons} from 'react-native';
...
const Points = () => {
    ...
    useEffect(()=> {
        async function loadPosition() {
            ...
            if(status !== 'granted') {
                Alert.alert('Oooopps', 'Precisamos de sua permissão para obter a localização');
                return;
            }
